...
<div class="menu-create-page p-1 p-md-3">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
        <div class="flex-grow-1">
            <h2 class="fw-bold mb-0 responsive-h2" style="color: #1e293b;">Edit Currency Symbol</h2>
            <p class="text-muted small mb-0">Modifying parameters for <span class="text-dark fw-bold">{{ $currency->name }}</span></p>
        </div>
                ...
                <div class="row g-4 g-lg-5">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="item-stats-list">
                            <div class="d-flex justify-content-between align-items-center py-3 border-bottom">
                                ...
                                <div class="form-check form-switch p-0 m-0">
                                    <input class="form-check-input premium-switch" type="checkbox" name="is_active" value="1" id="statusSwitch" {{ $currency->is_active ? 'checked' : '' }}>
                                </div>
                            </div>
                            <div class="py-2">
                                ...
                                @else
                                <span id="statusBadge" class="badge-status bg-danger-subtle text-danger justify-content-center w-100 mt-2">
                                    <span class="dot"></span> Inactive Symbol
                                </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="mt-4 p-4 bg-light rounded-lg border border-dashed text-center">
                            <i data-lucide="shield-check" class="text-muted mb-2" style="width: 40px; height: 40px; opacity: 0.5;"></i>
                            <h6 class="fw-bold extra-small text-uppercase text-muted mb-2">Security & Audit</h6>
                            <p class="extra-small text-muted mb-0">All changes to financial symbols are tracked in the system audit logs.</p>
                        </div>

                        <button type="button" class="btn btn-outline-danger w-100 mt-4 py-2 fw-bold extra-small text-uppercase rounded-lg"
                                onclick="confirmDelete('delete-form-{{ $currency->id }}', '{{ $currency->name }}')">
                            <i data-lucide="trash-2" class="me-2" style="width: 14px;"></i> Remove Symbol
                        </button>
                    </div>
                    ...
                    <div class="col-lg-8 border-start-lg">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" class="form-control premium-field @error('name') is-invalid @enderror" value="{{ old('name', $currency->name) }}" placeholder="e.g. US Dollar, Cambodian Riel" required>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group premium-group shadow-sm" style="max-width: 250px;">
                                ...
                                <input type="text" name="symbol" class="form-control premium-field border-start-0 @error('symbol') is-invalid @enderror" value="{{ old('symbol', $currency->symbol) }}" placeholder="e.g. $, ៛" required>
                            </div>
