...
<div class="category-edit-page p-1 p-md-3">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
        <div class="flex-grow-1">
            <h2 class="fw-bold mb-0 responsive-h2" style="color: #1e293b;">Edit Category: {{ $category->name }}</h2>
            <p class="text-muted small mb-0">Updating structural metadata for organizational unit #{{ $category->id }}</p>
        </div>
                ...
                <div class="row g-4 g-lg-5">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" class="form-control premium-field @error('name') is-invalid @enderror" value="{{ old('name', $category->name) }}" placeholder="e.g. Italian Specialties" required>
                        ...
                        <div class="mb-4 mb-md-5">
                            ...
                            <textarea name="description" class="form-control premium-field @error('description') is-invalid @enderror" rows="5" placeholder="Briefly describe what items fall under this category...">{{ old('description', $category->description) }}</textarea>
                            ...
                            <div class="py-2">
                                ...
                                @else
                                    <span id="statusBadge" class="badge-status bg-secondary-subtle text-secondary justify-content-center w-100 mt-2">
                                        <span class="dot"></span> Hidden / Disabled
                                    </span>
                                @endif
                            </div>
                        </div>
...
<style>
    ...
    .category-edit-page { font-family: 'Kantumruy Pro', sans-serif; }
