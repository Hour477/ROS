...
@section('content')
<div class="menu-edit-page p-1 p-md-3">
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="input-group premium-group shadow-sm">
                                    ...
                                    <input type="number" step="0.01" name="price" class="form-control premium-field @error('price') is-invalid @enderror" value="{{ old('price', $menuItem->price) }}" placeholder="0.00" required>
                                </div>
...
<style>
    ...
    .menu-edit-page { font-family: 'Kantumruy Pro', sans-serif; }

    /* Layout & Spacing */
    .responsive-h2 { font-size: calc(1.3rem + .5vw); }
    .extra-small { font-size: 0.65rem; }
    .responsive-image { height: 350px; }
    @media (max-width: 576px) { .responsive-image { height: 260px; } }
