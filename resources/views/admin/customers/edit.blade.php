...
<div class="user-form-page p-3 p-md-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-black mb-0 text-dark">Edit Customer</h2>
            <p class="text-muted small fw-bold mb-0 text-uppercase tracking-wider">Update client information</p>
        </div>
                    ...
                    <div class="col-lg-8">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" name="email" class="form-control premium-field @error('email') is-invalid @enderror"
                                    placeholder="customer@email.com" value="{{ old('email', $customer->email) }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="phone" class="form-control premium-field @error('phone') is-invalid @enderror"
                                    placeholder="+000 000 000" value="{{ old('phone', $customer->phone) }}">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="address" class="form-control premium-field @error('address') is-invalid @enderror"
                                    style="height: 100px; padding-top: 12px;" placeholder="Full residential address">{{ old('address', $customer->address) }}</textarea>
                        ...
                        <div class="mt-5 pt-4 border-top">
                            <button type="submit" class="btn btn-primary px-5 py-3 fw-black rounded-lg shadow-sm transform-active text-uppercase">
                                <i data-lucide="refresh-cw" class="me-2"></i> Update Records
                            </button>
                        </div>
                    </div>
                </div>
