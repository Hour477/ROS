...
<div class="table-create-page p-1 p-md-3">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
        <div class="flex-grow-1">
            <h2 class="fw-bold mb-0 responsive-h2" style="color: #1e293b;">New Dining Table</h2>
            <p class="text-muted small mb-0">Registering a new seating area for your restaurant</p>
        </div>
                ...
                <div class="row g-4 g-lg-5">
                    ...
                    <div class="col-lg-4 text-center">
                        <div class="item-info-header mb-3 text-start">
                            <span class="info-label text-uppercase mb-1 d-block">Categorization</span>
                        </div>
                        ...
                        <div class="p-5 bg-light rounded-lg border border-dashed mb-4 d-flex flex-column align-items-center justify-content-center" style="min-height: 250px;">
                            ...
                            <h5 class="fw-bold text-dark">Table Layout</h5>
                            <p class="small text-muted mb-0">Define the physical space and capacity for this seating unit.</p>
                        </div>
                        ...
                        <div class="item-stats-list text-start">
                            <div class="d-flex justify-content-between align-items-center py-3 border-bottom">
                                ...
                                <select name="status" class="form-select border-0 bg-transparent text-end fw-bold p-0" style="width: auto; box-shadow: none;">
                        ...
                        <div class="mt-4 p-3 bg-light rounded-lg border border-dashed text-start">
                             ...
                             <p class="extra-small text-muted mb-0">Newly registered tables are set to 'Available' by default for immediate guest seating.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" class="form-control premium-field @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="e.g. VIP-01 or Table 12" required>
                        ...
                        <div class="d-flex flex-wrap gap-2 pt-3 border-top justify-content-end">
                            <button type="submit" class="btn btn-orange px-4 py-3 d-flex align-items-center gap-2 shadow-sm">
                                ...
                                <span class="fw-bold">Register Table</span>
                            </button>
