...
@section('title', __('Add New Table'))
...
<div class="table-create-page p-1 p-md-3">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
        <div class="flex-grow-1">
            <h2 class="fw-bold mb-0 responsive-h2" style="color: #1e293b;">{{ __('Add New Table') }}</h2>
                ...
                <div class="row g-4 g-lg-5">
                    ...
                    <div class="col-lg-4 text-center">
                        ...
                        <div class="mt-4 p-3 bg-light rounded-lg border border-dashed text-start">
                             ...
                             <p class="extra-small text-muted mb-0">{{ __('Newly registered tables are set to Available by default.') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-8">
                        ...
                        <!-- Input: Name -->
                        <div class="mb-4">
                            <label class="info-label mb-2">{{ __('Table Number / Name') }} (EN) :</label>
                        ...
                        <!-- Input: Name KH -->
                        <div class="mb-4">
                            <label class="info-label mb-2">{{ __('Table Number / Name') }} (KH) :</label>
                            <input type="text" name="name_kh" class="form-control premium-field @error('name_kh') is-invalid @enderror" value="{{ old('name_kh') }}" placeholder="ឧទាហរណ៍៖ VIP-01 ឬ តុលេខ ១២">
                            @error('name_kh') <div class="invalid-feedback fw-bold">{{ $message }}</div> @enderror
                        </div>
