...
@section('content')
<div class="table-edit-page p-1 p-md-3">
    <!-- Sophisticated Header -->
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
        <div class="flex-grow-1">
            <h2 class="fw-bold mb-0 responsive-h2" style="color: #1e293b;">{{ __('Edit Table') }}: {{ app()->getLocale() == 'kh' && $table->name_kh ? $table->name_kh : $table->name }}</h2>
                ...
                <div class="row g-4 g-lg-5">
                    ...
                    <div class="col-lg-4 text-center">
                        <div class="item-info-header mb-3 text-start">
                            <span class="info-label text-uppercase mb-1 d-block">{{ __('Current Status') }}</span>
                        </div>
                        ...
                        <div class="mt-4 p-3 bg-light rounded-lg border border-dashed text-start">
                             ...
                             <p class="extra-small text-muted mb-0">{{ __('Changes to table status reflect immediately on the systems.') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name_kh" class="form-control premium-field @error('name_kh') is-invalid @enderror" value="{{ old('name_kh', $table->name_kh) }}" placeholder="ឧទាហរណ៍៖ VIP-01">
...
<style>
    ...
    .table-edit-page { font-family: 'Kantumruy Pro', sans-serif; }
